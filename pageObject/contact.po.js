...
exports.ContactPage = class ContactPage {
    constructor(page) {
        ...
        this.stateOrProvince = '//input[@placeholder="State or Province"]';
    ...
    async contactAdd(firstName,lastName,dateOfBirth,email,phone,address,city,state,postal,country) {
        ...
        await this.page.locator(this.stateOrProvince).fill(state);
    ...
    async contactDelete(firstName,lastName,dateOfBirth,email,phone,address,city,state,postal,country) {
    ...
    async validContactCreated(fName,lName,dob,email,phone,address,city,state,postal,country){
